...
public class TransfersMoney {
    ...
    public static void transferMoney(int id, int money) throws InterruptedException {
        ...
        for (AccountCustomer obj : accSequenceManager) {
            if (obj.getIdentify() == id && id != acctmp.getIdentify())
...
//Phần ghi lại lịch sử
                    ...
                    //Phần thông báo cho người nhận. sửa chỗ này
                    ...
                    try {
                        ...
                        System.out.println("Nhập lại số tiền hoặc nhấn 0 để quay lại");
                        money = Integer.parseInt(scan.nextLine());
                    } catch (NumberFormatException e) {
                        System.out.println("Đầu vào phải là số");
                    }
                }
            }
        } else {
            System.out.println("[ID không phù hợp]");
        }
    }
}